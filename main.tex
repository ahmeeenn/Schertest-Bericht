...
\usepackage[colorlinks, backref=true, pdfpagelabels, pdfstartview=FitH, bookmarksopen=true, bookmarksnumbered=true, pdftitle={Berichte}, pdfauthor={Ahmed EN-NOUR}, pdfsubject={MST}, pdfcreator={},pdfproducer={}, pdfkeywords={MST, } {Messung, } {Labor}, pdfnewwindow=true, colorlinks=true, linkcolor=black, plainpages=false, hypertexnames=false, citecolor=black, filecolor=black, linkcolor=black, urlcolor=black]{hyperref}
...
{\large \textbf{ Alaa Albasha, Matr. Nr.: xxxxxx\\Jan-Manuel Megerle, Matr. Nr.: xxxxxx\\Nathan Kirori, Matr. Nr.: xxxxxx \\Ahmed EN-NOUR, Matr. Nr.: 937048}}
...
\input{Sections/04-Projektmanagement}
...
\input{Sections/05-Proben und Methoden}
...
\input{Sections/08-Zusammenfassung}
